      ...
      resources: {
        en: {
          translation: {
            ...
            "brochures.createFirstDescription": "Create your first professional real estate brochure with our easy-to-use AI templates",
            ...
            "billing.purchaseSuccess": "Successfully purchased {{credits}} credits!",
            "billing.purchaseFailed": "Failed to process your purchase. Please try again.",
            "billing.loading": "Loading...",
            "billing.title": "Billing & Credits",
            "billing.subtitle": "Purchase credits to create brochures and use premium features",
            ...
            "billing.purchaseCreditsDesc": "Buy credit packages that best suit your needs.",
            "billing.createBrochures": "Create Brochures",
            "billing.createBrochuresDesc": "Use 1 credit for each brochure you generate.",
            "billing.noExpiration": "No Expiration",
            "billing.noExpirationDesc": "Your credits never expire and can be used anytime.",
            
            // Account Page
            "account.fillAllFields": "Please fill in all required fields correctly",
            ...
            "account.profileCompleted": "Profile completed successfully! Redirecting to dashboard...",
            ...
            "account.beforeCreate": "Before you can create brochures, we need some basic information about you",
            "account.backToDashboard": "Back to Dashboard",
            "account.brokerProfileInfo": "Broker Profile Information",
            "account.infoForBrochures": "This information will be used in your real estate brochures and templates.",
            ...
            "account.addressPlaceholder": "123 Main Street, Apt 4B, New York, NY 10001",
            "account.websiteNote": "Enter your website address (https:// will be added automatically if needed)",
            "account.addressNote": "Enter complete address: street name, house number, ZIP code, and city",
            ...
            "formSteps.template.description": "Select a template for your project",
            "formSteps.pages.title": "Pages",
            "formSteps.pages.description": "Select pages to include",
            "formSteps.basicInfo.title": "Basic Info",
            "formSteps.basicInfo.description": "Enter basic information about your project",
            ...
            "api.keyMissing": "OpenRouter API key is missing. Please add it to your .env file.",
            "api.keyInvalidFormat": "OpenRouter API key has invalid format. It should start with 'sk-or-v1-'.",
            "api.keyInvalid": "Invalid OpenRouter API key. Please check your credentials.",
            "api.rateLimit": "OpenRouter API rate limit exceeded. Please try again later.",
            "api.networkError": "Network error connecting to OpenRouter API. Check your internet connection.",
            "api.verifyFailed": "Failed to verify API connection",
            
            // Document Processing
            "document.extracting": "Extracting property information...",
            "document.extractFailed": "Failed to extract information from document",
            "document.extractSuccess": "Successfully extracted {{count}} field",
            "document.extractSuccess_plural": "Successfully extracted {{count}} fields",
            "document.missingFields": "Some critical fields couldn't be extracted: {{fields}}. Please fill them manually.",
            "document.noFieldsExtracted": "No fields could be extracted from the document. Please fill in fields manually.",
            "basicInfo.documentTitle": "Document Upload",
            "basicInfo.uploadInstructions": "Upload a document or paste text to extract property information",
            ...
            "basicInfo.enterDetailedDescription": "Enter detailed property description",
            ...
            "pagesSelection.description": "Select which pages to include in your brochure",
            ...
            "imagesStep.companyLogoDesc": "Upload your company logo that will appear on all pages",
            "imagesStep.agentPhoto": "Agent Photo",
            "imagesStep.agentPhotoDesc": "Upload a professional photo of the agent",
            ...
            "imagesStep.exteriorPhotosDesc": "Upload exterior photos of the property (max 2)",
            ...
            "imagesStep.interiorPhotosDesc": "Upload interior photos of the property (max 2)",
            ...
            "imagesStep.energyCertificateDesc": "Upload the energy certificate images (max 2)",
            "imagesStep.energyPage1": "Energy Certificate Page 1",
            "imagesStep.energyPage2": "Energy Certificate Page 2",
            "imagesStep.uploadInfo": "Upload images for your selected pages. The system will automatically organize them in your brochure.",
            ...
            "imageUploader.dragAndDrop": "Drag and drop your images here, or click to browse your files",
            "imageUploader.supportedFormats": "Supported formats: JPG, PNG, WEBP • Max size: 5MB",
            "imageUploader.edit": "Edit",
            "imageUploader.remove": "Remove",
            "imageUploader.enhanceImage": "Enhance Image",
            "imageUploader.enhanceTip": "Increase Lighting in image. Click reset if needed",
            ...
            "imageUploader.blurInstructions1": "Click and drag to draw blur regions",
            "imageUploader.blurInstructions2": "Double-click a region to remove it",
            ...
            "amenities.enterInfo": "Enter information about the property's amenities and features",
            "amenities.shortDescription": "Short Description",
            "amenities.enterShortDescription": "Enter a short description of the property highlighting key amenities",
            ...
            "review.description": "Please review all information before submitting.",
            ...
            "project.briefDescriptionPlaceholder": "Brief description of the property",
            "project.layoutDescription": "Layout Description",
            "project.detailedLayoutPlaceholder": "Detailed layout description of the property",
            "project.detailedDescription": "Detailed Description",
            "project.comprehensiveDescriptionPlaceholder": "Comprehensive property description",
            "project.uploadImagesInfo": "Upload and manage images for your project. These images will be used in your brochure.",
            ...
            "documentViewer.addImagesBeforeProcessing": "Please add at least one image before processing",
            "documentViewer.failedToProcessPresentation": "Failed to process presentation",
            "documentViewer.noProcessedDocument": "No processed document to download",
            "documentViewer.failedToDownloadPDF": "Failed to download presentation as PDF",
            "documentViewer.failedToUploadImage": "Failed to upload image",
            "documentViewer.imageReplacedSuccessfully": "Image replaced successfully",
        ...
        de: {
          translation: {
            ...
            // Dashboard Section
            "dashboard.title": "Dashboard",
            "dashboard.subtitle": "Erstellen und verwalten Sie Ihre Immobilienbroschüren",
            ...
            "brochures.subtitle": "Ansicht und Verwaltung Ihrer Immobilienbroschüren",
            "brochures.createNew": "Neue Broschüre erstellen",
            "brochures.yourBrochures": "Ihre Broschüren",
            "brochures.noBrochuresYet": "Sie haben noch keine Broschüren erstellt",
            "brochures.createFirstDescription": "Erstellen Sie Ihre erste professionelle Immobilienbroschüre mit unseren einfachen AI-Vorlagen",
            "brochures.createFirstButton": "Erstellen Sie Ihre erste Broschüre",
            
            // Billing Page
            "billing.mustBeLoggedIn": "Sie müssen angemeldet sein, um Kredite zu kaufen",
            "billing.invalidPackage": "Ungültiges Paket ausgewählt",
            "billing.purchaseSuccess": "{{credits}} Kredite erfolgreich gekauft!",
            "billing.purchaseFailed": "Fehler beim Verarbeiten Ihrer Bestellung. Bitte versuchen Sie es erneut.",
            "billing.loading": "Wird geladen...",
            "billing.title": "Abrechnung & Guthaben",
            "billing.subtitle": "Kredite kaufen, um Broschüren zu erstellen und Premium-Funktionen zu verwenden",
            "billing.currentBalance": "Aktuelles Guthaben",
            "billing.credits": "Kredite",
            "billing.costPerBrochure": "Jede Broschüre kostet 1 Kredit zum Generieren",
            "billing.buyMoreCredits": "Mehr Kredite kaufen",
            "billing.creditPackages": "Kreditpakete",
            "billing.choosePackage": "Wählen Sie ein Paket, das zu Ihren Bedürfnissen passt",
            ...
            "billing.purchaseCreditsDesc": "Kreditpakete kaufen, die am besten zu Ihren Bedürfnissen passen.",
            "billing.createBrochures": "Broschüren erstellen",
            "billing.createBrochuresDesc": "1 Kredit für jede Broschüre, die Sie generieren.",
            "billing.noExpiration": "Keine Ablaufzeit",
            "billing.noExpirationDesc": "Ihre Kredite verfallen nie und können jederzeit verwendet werden.",
            
            // Account Page
            "account.fillAllFields": "Bitte füllen Sie alle erforderlichen Felder korrekt aus",
            "account.savingInfo": "Informationen werden gespeichert...",
            "account.saveFailed": "Informationen konnten nicht gespeichert werden",
            "account.profileUpdated": "Profil erfolgreich aktualisiert",
            "account.profileCompleted": "Profil erfolgreich abgeschlossen! Umleitung zur Dashboard...",
            ...
            "account.beforeCreate": "Bevor Sie Broschüren erstellen können, benötigen wir einige grundlegende Informationen über Sie",
            "account.backToDashboard": "Zurück zum Dashboard",
            "account.brokerProfileInfo": "Maklerprofilinformationen",
            "account.infoForBrochures": "Diese Informationen werden in Ihren Immobilienbroschüren und Vorlagen verwendet.",
            ...
            "account.websitePlaceholder": "www.yourcompany.com",
            "account.addressPlaceholder": "123 Main Street, Apt 4B, New York, NY 10001",
            "account.websiteNote": "Geben Sie Ihre Webseite ein (https:// wird automatisch hinzugefügt, wenn es benötigt wird)",
            "account.addressNote": "Geben Sie die vollständige Adresse ein: Straßenname, Hausnummer, ZIP-Code und Stadt",
            "account.validEmailRequired": "Gültige E-Mail-Adresse ist erforderlich",
            ...
            "formSteps.template.description": "Wählen Sie eine Vorlage für Ihr Projekt",
            "formSteps.pages.title": "Seiten",
            "formSteps.pages.description": "Wählen Sie die einzuschließenden Seiten",
            "formSteps.basicInfo.title": "Grundlegende Infos",
            "formSteps.basicInfo.description": "Geben Sie grundlegende Informationen zu Ihrem Projekt ein",
            "formSteps.images.title": "Bilder",
            "formSteps.images.description": "Laden Sie Bilder für Ihr Projekt hoch",
            "formSteps.amenities.title": "Ausstattung",
            "formSteps.amenities.description": "Fügen Sie Ausstattungsmerkmale hinzu",
            "formSteps.contactInfo.title": "Kontaktinformationen",
            "formSteps.contactInfo.description": "Fügen Sie Kontaktinformationen hinzu",
            "formSteps.review.title": "Überprüfung",
            "formSteps.review.description": "Überprüfen Sie Ihr Projekt vor der Erstellung",
            ...
            // Form Validation Errors
            "error.selectTemplate": "Bitte wählen Sie eine Vorlage aus, um fortzufahren",
            "error.selectPages": "Bitte wählen Sie Seiten aus, um fortzufahren",
            "error.titleRequired": "Projekttitel ist erforderlich",
            "error.loginRequired": "Sie müssen angemeldet sein, um ein Projekt zu erstellen",
            
            // API Error Messages
            "api.connectionFailed": "API-Verbindung fehlgeschlagen.",
            "api.keyMissing": "OpenRouter API-Schlüssel fehlt. Bitte fügen Sie ihn zu Ihrer .env-Datei hinzu.",
            "api.keyInvalidFormat": "OpenRouter API-Schlüssel hat ein ungültiges Format. Er sollte mit 'sk-or-v1-' beginnen.",
            "api.keyInvalid": "Ungültiger OpenRouter API-Schlüssel. Bitte überprüfen Sie Ihre Anmeldedaten.",
            "api.rateLimit": "OpenRouter API-Ratenlimit überschritten. Bitte versuchen Sie es später erneut.",
            "api.networkError": "Netzwerkfehler bei der Verbindung zur OpenRouter API. Überprüfen Sie Ihre Internetverbindung.",
            ...
            "document.extractFailed": "Informationen konnten nicht aus dem Dokument extrahiert werden",
            "document.extractSuccess": "{{count}} Feld erfolgreich extrahiert",
            "document.extractSuccess_plural": "{{count}} Felder erfolgreich extrahiert",
            "document.missingFields": "Einige wichtige Felder konnten nicht extrahiert werden: {{fields}}. Bitte füllen Sie diese manuell aus.",
            "document.noFieldsExtracted": "Es konnten keine Felder aus dem Dokument extrahiert werden. Bitte füllen Sie die Felder manuell aus.",
            
            // Add the BasicInfo translations
            "basicInfo.documentTitle": "Dokument hochladen",
            "basicInfo.uploadInstructions": "Laden Sie ein Dokument hoch oder fügen Sie Text ein, um Immobilieninformationen zu extrahieren",
            ...
            "basicInfo.fillEdit": "Füllen Sie die folgenden Informationen aus oder bearbeiten Sie sie",
            ...
            "basicInfo.enterShortDescription": "Geben Sie eine kurze Beschreibung ein",
            ...
            "basicInfo.enterSitePlanDescription": "Lageplan-Beschreibung eingeben",
            "basicInfo.detailedDescription": "Detaillierte Beschreibung",
            "basicInfo.enterDetailedDescription": "Detaillierte Immobilienbeschreibung eingeben",
            "basicInfo.regenerateCriticalFields": "Kritische Felder neu generieren",

            // Pages selection translations for German
            "pagesSelection.title": "Einzuschließende Seiten",
            "pagesSelection.description": "Wählen Sie aus, welche Seiten in Ihre Broschüre aufgenommen werden sollen",
            ...
            "imagesStep.companyLogoDesc": "Laden Sie Ihr Firmenlogo hoch, das auf allen Seiten erscheinen wird",
            "imagesStep.agentPhoto": "Foto des Maklers",
            "imagesStep.agentPhotoDesc": "Laden Sie ein professionelles Foto des Maklers hoch",
            "imagesStep.projectOverview": "Projektübersichtsbild",
            "imagesStep.projectOverviewDesc": "Laden Sie das Hauptprojektbild hoch",
            ...
            "imagesStep.exteriorPhotosDesc": "Laden Sie Außenaufnahmen der Immobilie hoch (max. 2)",
            ...
            "imagesStep.interiorPhotosDesc": "Laden Sie Innenaufnahmen der Immobilie hoch (max. 2)",
            ...
            "imagesStep.energyCertificateDesc": "Laden Sie die Bilder des Energieausweises hoch (max. 2)",
            "imagesStep.energyPage1": "Energieausweis Seite 1",
            "imagesStep.energyPage2": "Energieausweis Seite 2",
            "imagesStep.uploadInfo": "Laden Sie Bilder für Ihre ausgewählten Seiten hoch. Das System wird sie automatisch in Ihrer Broschüre organisieren.",

            // ImageUploader translations in German
            "imageUploader.addImage": "Bild hinzufügen",
            "imageUploader.uploading": "Wird hochgeladen...",
            "imageUploader.dropHere": "Datei hier ablegen oder klicken zum Durchsuchen",
            "imageUploader.uploadImages": "Immobilienbilder hochladen",
            "imageUploader.dragAndDrop": "Ziehen Sie Ihre Bilder hierher oder klicken Sie, um Ihre Dateien zu durchsuchen",
            "imageUploader.supportedFormats": "Unterstützte Formate: JPG, PNG, WEBP • Maximale Größe: 5MB",
            "imageUploader.edit": "Bearbeiten",
            "imageUploader.remove": "Entfernen",
            "imageUploader.enhanceImage": "Bild verbessern",
            "imageUploader.enhanceTip": "Beleuchtung im Bild erhöhen. Klicken Sie bei Bedarf auf Zurücksetzen",
            ...
            "imageUploader.blurInstructions1": "Klicken und ziehen Sie, um Unschärfebereiche zu zeichnen",
            "imageUploader.blurInstructions2": "Doppelklicken Sie auf einen Bereich, um ihn zu entfernen",
            ...
            "amenities.enterInfo": "Geben Sie Informationen zu den Ausstattungsmerkmalen der Immobilie ein",
            "amenities.shortDescription": "Kurzbeschreibung",
            "amenities.enterShortDescription": "Geben Sie eine kurze Beschreibung der Immobilie mit den wichtigsten Ausstattungsmerkmalen ein",
            ...
            "contactInfo.enterInfo": "Geben Sie Kontaktinformationen für die Immobilie ein",
            ...
            "contactInfo.enterBrokerFirmAddress": "Adresse der Maklerfirma eingeben",
            
            // ReviewStep translations in German
            "review.title": "Informationen überprüfen",
            "review.description": "Bitte überprüfen Sie alle Informationen vor dem Absenden.",
            ...
            "project.briefDescriptionPlaceholder": "Kurze Beschreibung der Immobilie",
            "project.layoutDescription": "Lagebeschreibung",
            "project.detailedLayoutPlaceholder": "Detaillierte Lagebeschreibung der Immobilie",
            "project.detailedDescription": "Detaillierte Beschreibung",
            "project.comprehensiveDescriptionPlaceholder": "Umfassende Immobilienbeschreibung",
            "project.uploadImagesInfo": "Laden Sie Bilder für Ihr Projekt hoch und verwalten Sie sie. Diese Bilder werden in Ihrer Broschüre verwendet.",
            ...
            // DocumentViewer translations
            "documentViewer.addImagesBeforeProcessing": "Bitte fügen Sie mindestens ein Bild hinzu, bevor Sie fortfahren",
            "documentViewer.failedToProcessPresentation": "Fehler bei der Verarbeitung der Präsentation",
            "documentViewer.noProcessedDocument": "Kein verarbeitetes Dokument zum Herunterladen",
            "documentViewer.failedToDownloadPDF": "Fehler beim Herunterladen der Präsentation als PDF",
            "documentViewer.failedToUploadImage": "Fehler beim Hochladen des Bildes",
            "documentViewer.imageReplacedSuccessfully": "Bild erfolgreich ersetzt",
            "documentViewer.failedToReplaceImage": "Fehler beim Ersetzen des Bildes",
            ...
            "documentViewer.processingPresentation": "Präsentation wird verarbeitet...",
