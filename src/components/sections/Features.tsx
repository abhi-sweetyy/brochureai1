...
export default function Features() {
  ...
  return (
    <>
      ...
      <section id="features" className="max-w-6xl mx-auto px-5 sm:px-6 py-16 md:py-20 bg-white">
      ...
      >
        {/* Mobile-friendly tabs positioned completely above the content box, centered */}
        <div className="flex justify-center mb-8 relative overflow-x-auto pb-2 -mx-5 px-5">
          {/* Gray line positioned over the entire tab width */}
        ...
        <div className="bg-[#F8F8FC] rounded-xl p-6 sm:p-8 md:p-10 relative md:min-h-[400px] shadow-md">
          ...
          {/* Professional Templates Content */}
          {activeTab === "templates" && (
            <div className="flex flex-col lg:flex-row h-full gap-6">
              <div className="lg:w-1/2 pr-0 lg:pr-8">
                <h3 className="text-xl sm:text-2xl font-bold mb-4 text-[#171717]">
          ...
          {/* Navigation arrows and counter at bottom */}
